...
const Profile = () => {
  ...
  const saveChanges=async()=>{
    if(validateProfile()){
      try{
        const res=await apiClient.post(UPDATE_PROFILE_ROUTE,{firstName,lastName,colors:selectedColor},
    ...
    <div className='bg-[#1b1c24] h-[100vh] flex items-center justify-center flex-col gap-10'>
      <div className='flex flex-col gap-10 w-[80vw] md:w-max'>
        ...
        <div className='grid grid-cols-2'>
          <div className='h-full w-32 md:w-48 md:h-48 relative flex items-center justify-center' onMouseEnter={()=>{
            setHovered(true)
          }}
          onMouseLeave={()=>{
            setHovered(false)
          ...
          <div className='flex min-w-32 md:min-w-64 flex-col gap-5 text-white items-center justify-center '>
            ...
            <div className=' w-full '>
              ...
              value={firstName} className='rounded-lg p-6 bg-[#2c2e3b] border-none '></Input>
            </div>
            <div className=' w-full '>
              ...
              type='text' value={lastName} className='rounded-lg p-6 bg-[#2c2e3b] border-none '></Input>
            </div>
        ...
        <div className='w-full'> <Button className='h-16 w-full bg-purple-700 hover:bg-purple-900 transition-all duration-300 ' onClick={saveChanges}>Save changes </Button></div>
      </div>
